...
//<###INSERT>
			$q = $pdo->prepare("INSERT INTO dyn_tbl_menu_3_submenu_4(insert_date, CreatedDate_95,UpdateDate_92,Sl_53,SOPCode_10,Description_65) 
 VALUES (now(),?,?,?,?,? )");
			$q->execute(array($CreatedDate_95,$UpdateDate_92,$Sl_53,$SOPCode_10,$Description_65));
			Database::disconnect();

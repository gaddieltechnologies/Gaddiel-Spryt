...
$Name_30= $_POST["Name_30"];
		if ($valid) {
			...
			$q = $pdo->prepare("UPDATE dyn_tbl_menu_4_submenu_5 SET Name_30 = ? WHERE id= ?");
			$q->execute(array($Name_30,$ID));
			Database::disconnect();
...
$pdo = Database::connect();
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$result = $pdo->prepare("SELECT ID,Name_30 FROM dyn_tbl_menu_4_submenu_5 WHERE id= :id");

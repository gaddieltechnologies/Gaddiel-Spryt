...
//<###INSERT>
			$q = $pdo->prepare("INSERT INTO dyn_tbl_menu_2_submenu_2(insert_date, ProductCategory_94,NoofUnits_72,ItemUOM_31,Buyer_64,Customer_42,DeliverBy_45,DeliverBy_86) 
 VALUES (now(),?,?,?,?,?,?,? )");
			$q->execute(array($ProductCategory_94,$NoofUnits_72,$ItemUOM_31,$Buyer_64,$Customer_42,$DeliverBy_45,$DeliverBy_86));
			Database::disconnect();

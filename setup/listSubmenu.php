			   ...
			   <div class="span12 desktop">
				 <div class="widget">                 					
					<div class="widget-content "> 
						<div class="span8"><h3>Submenu Setup</h3></div>                       
						<div class="span3">                                                                
				...
				<!-- /Content -->
					<div class="span12">
					    <div class="widget">					
						<div class="widget-content">
							<div class="mobile"><h3>Submenu Details</h3></div> 													
...
echo "In php";								 
									...
									$result = $pdo->prepare("SELECT submenu.submenu_id, menu.menu_name, submenu.submenu_name, submenu.display_order, submenu.short_desc, submenu.long_desc
									FROM menu, submenu
						...
						*/		
			 				      ...
			 				      ?>										  
									<tr Style="cursor:pointer;">
                                      <td class="actions">										   
											<a href="editSubmenu.php?id=<?php echo $row['submenu_id']; ?>" class="btn btn-small  "><i class="icon-pencil"></i></a>
											<a href="deleteSubmenu.php?id=<?php echo $row['submenu_id']; ?>" class="btn btn-small " onclick="return confirm('Are you sure?')"><i class="icon-remove"></i></a>
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">                         
                       ...
                       <a href="setup/addSubmenu.php" class="newenable btn btn-default" onClick="newPage()" id="newenable">

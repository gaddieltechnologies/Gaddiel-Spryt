					...
					<div class="span12">	
						<div class="widget">
							...
							<div class="widget-content">		
								...
								<div class="span3"><label>Long Description<font color="#FF0000"> </font></label><input type="text"  name="LONG_DESC" id="LONG_DESC"  class="span3"></div>									 
		    ...
		    if ( !empty($_POST))
			{
               ...
               if($rows > 0) {
				...
				echo "connect; before insert";
              	$sql = "INSERT INTO submenu (insert_date,update_date, menu_id, submenu_name, display_order, short_desc, long_desc)  
						VALUES(now(), now(),?,?,?,?,?)";
                $q = $pdo->prepare($sql);
                $q->execute(array($MENU_ID,$SUBMENU_NAME,$DISPLAY_ORDER,$SHORT_DESC,$LONG_DESC));
				echo "insert done";
				Database::disconnect();
